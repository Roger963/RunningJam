...
Space.MainMenu.prototype = {
	create: function(){
		...
		this.add.button(Space.GAME_WIDTH-600-10, Space.GAME_HEIGHT-280-10, 'play', this.startGame, this, 1, 0, 2, 3,);
		//this.add.button(Space.GAME_WIDTH-401-10, Space.GAME_HEIGHT-143-10, 'Opciones', this.startGame, this, 1, 0, 2);
	},
	startGame: function() {
