...
Space.MainMenu.prototype = {
	create: function(){
		...
		//this.add.sprite(-130, Space.GAME_HEIGHT-514, 'monster-cover');
		this.add.sprite((Space.GAME_WIDTH-1220)/2, -80, 'RunningJam');
		// add the button that will start the game
		this.add.button(Space.GAME_WIDTH-601-10, Space.GAME_HEIGHT-343-10, 'play', this.startGame, this, 1, 0, 2);
